...
from PIL import Image
Fulham_img = Image.open('/LogoFile/Fulham_FC__shield_.jpg')
Bournemouth_img =Image.open('/LogoFile/AFC_Bournemouth_(2013).jpg')
Arsenal_img = Image.open('/LogoFile/Arsenal_FC.jpg')
AstonVilla_img = Image.open('/LogoFile/Aston_Villa_FC_new_crest.jpg')
Brentford_img = Image.open('/LogoFile/Brentford_FC_crest.svg.jpg')
Brighton_img = Image.open('/LogoFile/Brighton_and_Hove_Albion_FC_crest.jpg')
CrystalPalace_img = Image.open('/LogoFile/Crystal_Palace_FC_logo_(2022).jpg')
Chelsea_img = Image.open('/LogoFile/Chelsea_FC.jpg')
Everton_img = Image.open('/LogoFile/Everton_FC_logo.jpg')
Southhampton_img = Image.open('/LogoFile/FC_Southampton.jpg')
Ipswich_img = Image.open('/LogoFile/Ipswich_Town.jpg')
Leicester_img = Image.open('/LogoFile/Leicester_City_crest.jpg')
Liverpool_img = Image.open('/LogoFile/Liverpool_FC.jpg')
ManchesterCity_img = Image.open('/LogoFile/Manchester_City_FC_badge.jpg')
ManchesterUtd_img = Image.open('/LogoFile/Manchester_United_FC_crest.jpg')
Newcastle_img = Image.open('/LogoFile/Newcastle_United_Logo.jpg')
NottinghamFrst_img = Image.open('/LogoFile/Nottingham_Forest_F.C._logo.jpg')
Tottenham_img = Image.open('/LogoFile/Tottenham_Hotspur.jpg')
WesthamUtd_img = Image.open('/LogoFile/West_Ham_United_FC_logo.jpg')
Wolves_img = Image.open('/LogoFile/Wolverhampton_Wanderers_FC_crest.jpg')
